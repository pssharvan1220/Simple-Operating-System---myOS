...
[SEGMENT .data]
    strWelcomeMsg   db  "This is myOS Work space developed by Sajeesan who is an undergraduate student at university of kelaniya", 0x00
	strPrompt		db	"myOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"MY OS", 0x00	;OS details
